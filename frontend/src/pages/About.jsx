...
function About() {
  ...
  const skills = {
    ...
    "Tools": "Git, Wireshark, Ghidra, PyTorch, Pandas, Docker, Nginx, Vite, Ubuntu/Linux",
    "Creative": "Blender, Maya, Neovim"
  };
        ...
        <section className="mb-16">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
            <p className="text-lg text-slate-300 leading-relaxed mb-4">
              ...
              and build machine learning applications for Purdue's UAV research team.
            </p>
